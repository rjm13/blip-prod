    ...
    return (
        <View style={{ marginVertical: 10, backgroundColor: '#132F35', borderRadius: 15}}>
            ...
            <View style={{ margin: 10, flexDirection: 'row'}}>
                <View>
                   <Image 
                            source={ userImageUri ? { uri: userImageUri} : require('../assets/images/OdysseyLogo.png')}
        ...
        <View>
            <View style={{backgroundColor: '#363636', padding: 20, marginVertical: 10, borderRadius: 15, }}>
                <View style={{ flexDirection: 'row', }}>
                    <Image 
                            source={ user?.imageUri ? { uri: user?.imageUri} : require('../assets/images/OdysseyLogo.png')}
