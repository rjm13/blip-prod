...
{/* author modal */}
                <Modal visible={visible4} onDismiss={hideAuthorModal} contentContainerStyle={containerStyle}>
                    <View style={{height: '80%'}}>
                        <Text style={{color: '#fff', fontWeight: 'bold', fontSize: 16, marginLeft: 10}}>
                            Select Author
                        </Text>
...
{/* create user modal */}
                <Modal visible={visible5} onDismiss={hideCreateUserModal} contentContainerStyle={containerStyle}>
